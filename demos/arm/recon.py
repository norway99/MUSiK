...
z_heights = np.arange(-0.09, 0.11, 0.002)

for i in range(len(z_heights)):    
    image = test_reconstruction.selective_compound(workers=10, transducers=[i*6,i*6+1,i*6+2,i*6+3,i*6+4,i*6+5], resolution_multiplier=2, local=True, combine=True)
